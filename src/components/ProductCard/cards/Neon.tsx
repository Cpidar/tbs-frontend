...
import productPlaceholder from '@/images/placeholders/product-placeholder.png';
...
const AddToCart = dynamic(
  () =>
    import('@/components/ProductCard/add-to-cart/add-to-cart').then(
...
const product_type = variants?.length > 1 ? 'variable' : 'simple'
...
//   });
  ...
  function handleProductQuickView() {
    return setShowModalQuickView(true);
  }
  return (
    <article
      className={cn(
