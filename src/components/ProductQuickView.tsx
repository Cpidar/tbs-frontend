...
const ProductQuickView: FC<ProductQuickViewProps> = ({ data, className = "" }) => {
  const { name, price, description, thumbnail } = data
    ...
    return (
      <div className="space-y-8">
        ...
        <div className="flex space-x-3.5 rtl:space-x-reverse">
          <div className="flex items-center justify-end bg-slate-100/70 dark:bg-slate-800/70 px-2 py-3 sm:p-3.5 rounded-full">
            <NcInputNumber
          ...
          >
            ...
            <span className="ms-3">اضافه به سبد خرید</span>
          </ButtonPrimary>
        </div>
